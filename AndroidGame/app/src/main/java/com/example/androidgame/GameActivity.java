...
public class GameActivity extends Activity {
    private static final String TAG = com.example.androidgame.BreakoutActivity.TAG;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //caller.getLayoutInflater().inflate(R.layout.about, null);
    ...
    */
    ...
    private void updateHighScore(int lastScore) {
        SharedPreferences prefs = getSharedPreferences(com.example.androidgame.BreakoutActivity.PREFS_NAME, MODE_PRIVATE);
        int highScore = prefs.getInt(com.example.androidgame.BreakoutActivity.HIGH_SCORE_KEY, 0);
        ...
        if (lastScore > highScore) {
            ...
            editor.putInt(com.example.androidgame.BreakoutActivity.HIGH_SCORE_KEY, lastScore);
            editor.commit();
        }
    }
}
