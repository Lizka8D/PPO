...
public class GameSurfaceRenderer implements GLSurfaceView.Renderer {
    ...
    private final com.example.androidgame.GameState mGameState;
     ...
     */
    public GameSurfaceRenderer(com.example.androidgame.GameState gameState, GameSurfaceView surfaceView,
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig config) {
        ...
        com.example.androidgame.GameState gameState = mGameState;
    ...
    public void onSurfaceChanged(GL10 unused, int width, int height) {
        ...
        float arenaRatio = com.example.androidgame.GameState.ARENA_HEIGHT / com.example.androidgame.GameState.ARENA_WIDTH;
        ...
        Matrix.orthoM(mProjectionMatrix, 0,  0, com.example.androidgame.GameState.ARENA_WIDTH,
                0, com.example.androidgame.GameState.ARENA_HEIGHT,  -1, 1);
    ...
    public void touchEvent(float x) {
        ...
        float arenaX = (x - mViewportXoff) * (com.example.androidgame.GameState.ARENA_WIDTH / mViewportWidth);
        //float arenaY = (y - mViewportYoff) * (com.example.androidgame.GameState.ARENA_HEIGHT / mViewportHeight);
