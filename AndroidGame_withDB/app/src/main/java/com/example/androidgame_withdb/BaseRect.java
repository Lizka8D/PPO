...
public class BaseRect {
    ...
    private static final FloatBuffer sVertexArray = BaseRect.createVertexArray(COORDS);
    private static final FloatBuffer sTexArray = BaseRect.createVertexArray(TEX_COORDS);
    private static final FloatBuffer sOutlineVertexArray = BaseRect.createVertexArray(OUTLINE_COORDS);
